...
?>
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <form id="formAddPlace"
                      autocomplete="off"
                      action="../api/api.php/<?= (isset($placeId) ? 'update_nearby' : 'add_nearby'); ?>"
                      method="post">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="box box-warning">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <!--สถานที่ท่องเที่ยวที่อยู่ใกล้-->
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="selectPlace">สถานที่ท่องเที่ยวที่อยู่ใกล้:</label>
                                                <div class="input-group">
                                                <span class="input-group-addon">
                                                    <i class="fa fa-map-marker"></i>
                                                </span>
                                                    <select id="selectPlace" class="form-control" required
                                                            name="placeId"
                                                            oninvalid="this.setCustomValidity('เลือกสถานที่ท่องเที่ยว')"
                                                            oninput="this.setCustomValidity('')">
                                                        <option value="" disabled <?= empty($place) ? 'selected' : ''; ?>>-- เลือกสถานที่ท่องเที่ยว --</option>
                                                        <?php
                                                        foreach ($placeList as $p) {
                                                            ?>
                                                            <option value="<?= $p['id']; ?>" <?= (!empty($place) && ((int)$place['place_id'] === $p['id'])) ? 'selected' : ''; ?>>
                                                                <?= $p['name']; ?>
                                                            </option>
                                                            <?php
                                                        }
                            ...
                            <div class="box box-warning">
                                <div class="box-header with-border">
                                    <h3 class="box-title">รูปภาพ Cover
                                        <!--<small></small>-->
                                    </h3>
    ...
    <script>
        ...
        function doAddEditPlace() {
            ...
            $.ajax({
                url: '../api/api.php/<?= (isset($placeId) ? 'update_nearby' : 'add_nearby'); ?>',
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
                        ...
                        BootstrapDialog.show({
                            ...
                            buttons: [{
                                ...
                                action: function (self) {
                                    ...
                                    if (!isset($placeId)) {
                                    ?>
                                    window.location.href = 'nearby.php?place_type=<?php echo $placeType; ?>';
                                    <?php
                                    } else {
                                    ?>
