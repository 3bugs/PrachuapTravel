                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <table id="tablePlace_<?= $placeType; ?>" class="table table-bordered table-striped">
                                    <thead>
                                    <tr>
                                        <th style="text-align: center; width: 16%;">ชื่อสถานที่</th>
                                        <th style="text-align: center; width: 49%;">รายละเอียด</th>
                                        <th style="text-align: center; width: 25%;">ที่อยู่</th>
                                    ...
                                    if (sizeof($placeList) == 0) {
                                        ...
                                        foreach ($placeList as $place) {
                                            ...
                                            <tr style="">
                                                ...
                                                <!--รายละเอียด-->
                                                <td><?= nl2br($place['details']); ?></td>

                                                <!--ที่อยู่-->
                                                <td><?= $place['address'] ? $place['address'] : '<span style="color: orangered">ไม่มีข้อมูล</span>'; ?></td>
